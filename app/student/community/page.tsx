    ...
    <div className={`min-h-screen bg-[#F8F8F8] flex flex-col ${inter.className}`}> 
      ...
      <main className="flex flex-1 flex-col items-center justify-center py-10 px-2">
        <div className="text-center">
          <h1 className="text-4xl font-bold mb-4 text-[#2f3167]">Community Hub</h1>
          <p className="text-xl text-gray-600 mb-8">Coming Soon!</p>
          <p className="text-gray-500 mb-8">Connect with your peers, mentors, and the broader Inspirit AI community to collaborate and learn together.</p>
          <button
